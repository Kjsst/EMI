...
{{--                            </div>--}}
                            ...
                            <div class="change-password">
                                ...
                                <div class="admin-profile" onclick="addPhoto()">
                                    <div class="image-upload" id="image-upload">
                                        @if($merchant->QR_image)
                                        <img src="{{url("storage/images/".$merchant->QR_image)}}" alt="" id="image-profile"/>
                                        @else
                                            <img src="{{asset('/assets/img/photo_camera.svg')}}" alt="" id="image-profile"/>
                                        @endif
                                    </div>
                                    <div class="upload-camera">
                                        <img src="{{asset('/images/camera.png')}}" alt=""/>
                                    </div>
                                    <input style="display: none" type="file" name="QR_image" id="imageInput" accept="image/*"
                            ...
                            <div>
                                ...
                                <div class="form-control-s">
                                    ...
                                    <input name="brahmastra_coin" value="{{$merchant->brahmastra_coin}}" type="text"
                                ...
                                <div class="form-control-s">
                                    ...
                                    <input name="rambaan_coin" value="{{$merchant->rambaan_coin}}" type="text"
